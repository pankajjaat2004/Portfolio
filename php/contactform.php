...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo "'<H1 text-align='center' font-style='italic' color='green'>Thank you for contacting ,$name. I will get back to you soon!</H1>";
    } else {
        echo "<H1 text-align='center' font-style='italic' color='red'>Sorry, there was an error submitting your message. Please Refresh or try again later.</H1>";
    }
